...
export class OtpComponent  implements OnInit{
  ...
  constructor(private userserive:UserServiceService,private toaser:ToastrService,private formBuilder:FormBuilder,private activateroutes:ActivatedRoute,private http:HttpClient,private router:Router){}
  ngOnInit(): void {
  ...
  submitForm() {
    ...
    if (otp.otp=='') {
      ...
      this.userserive.postotp(otp).subscribe(()=>{this.toaser.success('Registered',"successfully",{progressBar:true}),this.router.navigate(['/login'])},(err)=>{
      this.toaser.error(err.error.message,'',{progressBar:true})
     })
